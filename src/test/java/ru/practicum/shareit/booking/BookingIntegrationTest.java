...
public class BookingIntegrationTest {
    ...
    void getAllBookingsTest() {
        List<BookingResponseDto> bookings = bookingService.getBookings(BookingState.ALL, booker.getId(), 0, 10);
    ...
    void getRejectedBookingsTest() {
        List<BookingResponseDto> bookings = bookingService.getBookings(BookingState.REJECTED, booker.getId(), 0, 10);
    ...
    void getWaitingBookingsTest() {
        List<BookingResponseDto> bookings = bookingService.getBookings(BookingState.WAITING, booker.getId(), 0, 10);
    ...
    void getCurrentBookingsTest() {
        List<BookingResponseDto> bookings = bookingService.getBookings(BookingState.CURRENT, booker.getId(), 0, 10);
    ...
    void getPastBookingsTest() {
        List<BookingResponseDto> bookings = bookingService.getBookings(BookingState.PAST, booker.getId(), 0, 10);
    ...
    void getFutureBookingsTest() {
        List<BookingResponseDto> bookings = bookingService.getBookings(BookingState.FUTURE, booker.getId(), 0, 10);
